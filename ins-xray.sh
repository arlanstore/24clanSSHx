...
# install nginx
mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/arlanstore/24clanSSHx/main/vps.conf.txt"
sleep 1
wget -q -O xraymode.sh https://raw.githubusercontent.com/arlanstore/24clanSSHx/main/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
wget -q -O /etc/xray/config.json "https://raw.githubusercontent.com/arlanstore/24clanSSHx/main/conf/config.json"
chmod +x /etc/xray/config.json
sleep 1 
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/arlanstore/24clanSSHx/main/conf/xray.conf"
