...
Name=$(curl -sS https://raw.githubusercontent.com/arlanstore/24clanSSHx/main/permission/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/arlanstore/24clanSSHx/main/permission/ip | grep $MYIP | awk '{print $3}')
